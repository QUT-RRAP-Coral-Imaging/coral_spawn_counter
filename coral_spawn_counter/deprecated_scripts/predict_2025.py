...
img_dir = '/media/dtsai/DT4TB/cslics_2023_datasets/2023_Dec_Spawning/20231205_alor_tank4_cslics01/images'
...
save_dir = os.path.join('/media/dtsai/DT4TB/cslics_2023_datasets/2023_Dec_Spawning/20231205_alor_tank4_cslics01/detections/' + Path(weights_path).stem)
...
img_list = sorted(Path(img_dir).rglob('cslics0*_img.jpg'))
